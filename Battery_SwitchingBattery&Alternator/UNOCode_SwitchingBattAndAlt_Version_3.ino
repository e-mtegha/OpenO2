// UNOCode_SwitchingBattAndAlt_Version_3
...
const unsigned long requestInterval = 200; // Request data every 200ms
const unsigned long noDataTimeout = 300;   // Timeout for no data (ms) - FAST SWITCH
